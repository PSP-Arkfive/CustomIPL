...
cipl:
	$(Q)$(MAKE) -C $(BOOTLOADEX)/nand_payloadex/
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) -C ClassicIPL/mainbinex
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) -C ClassicIPL/combine
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=01G -C NewIPL
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=02G -C NewIPL
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=03G -C NewIPL
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=04G -C NewIPL
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=05G -C NewIPL
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=07G -C NewIPL
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=09G -C NewIPL
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=11G -C NewIPL

msipl:
	$(Q)$(MAKE) -C $(BOOTLOADEX)/ms_payloadex/
	$(Q)$(MAKE) gcc -C MSIPL/minilzo
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) -C MSIPL/newipl/stage2
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) -C MSIPL/mainbinex
	...
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) -C MSIPL/newipl/stage1
	...
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=01G -C MSIPL/newipl/stage3/
	$(Q)mv MSIPL/newipl/stage3/ipl_01G.bin MSIPL/newipl/msipl_01g.bin
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=02G -C MSIPL/newipl/stage3/
	$(Q)mv MSIPL/newipl/stage3/ipl_02G.bin MSIPL/newipl/msipl_02g.bin
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=03G -C MSIPL/newipl/stage3/
	$(Q)mv MSIPL/newipl/stage3/ipl_03G.bin MSIPL/newipl/msipl_03g.bin
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=04G -C MSIPL/newipl/stage3/
	$(Q)mv MSIPL/newipl/stage3/ipl_04G.bin MSIPL/newipl/msipl_04g.bin
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=05G -C MSIPL/newipl/stage3/
	$(Q)mv MSIPL/newipl/stage3/ipl_05G.bin MSIPL/newipl/msipl_05g.bin
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=07G -C MSIPL/newipl/stage3/
	$(Q)mv MSIPL/newipl/stage3/ipl_07G.bin MSIPL/newipl/msipl_07g.bin
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) PSP_MODEL=09G -C MSIPL/newipl/stage3/
...
clean:
	...
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) -C MSIPL/minilzo clean
	$(Q)$(MAKE) BOOTLOADEX=$(BOOTLOADEX) -C MSIPL/mainbinex clean
